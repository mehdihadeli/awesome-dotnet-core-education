...
[![License](./docs/CC0-1.0](https://img.shields.io/badge/License-CC0%201.0-brightgreen.svg?style=flat-square)](http://creativecommons.org/publicdomain/zero/1.0/)
...
> **This awesome list is available here with better UI and searching feature](./docs/[https://mehdihadeli.github.io/awesome-dotnet-core-education](https://mehdihadeli.github.io/awesome-dotnet-core-education/)**
...
- [[Deep-dive into .NET Core primitives](./docs/deps.json, runtimeconfig.json, and dll's](https://natemcmaster.com/blog/2017/12/21/netcore-primitives/)
- [[Deep-dive into .NET Core primitives, part 2](./docs/the shared framework](https://natemcmaster.com/blog/2018/08/29/netcore-primitives-2/)
- [[Deep-dive into .NET Core primitives, part 3](./docs/runtimeconfig.json in depth](https://natemcmaster.com/blog/2019/01/09/netcore-primitives-3/)
- [[When ASP.NET Core can't find your controller](./docs/debugging application parts](https://andrewlock.net/when-asp-net-core-cant-find-your-controller-debugging-application-parts/)
...
- [[Tutorial](./docs/Create a .NET tool using the .NET CLI](https://docs.microsoft.com/en-us/dotnet/core/tools/global-tools-how-to-create)
...
- [[Deep-dive into .NET Core primitives, part 2](./docs/the shared framework](https://b2n.ir/083540)
- [[Framework Reference](https://docs.microsoft.com/en-us/aspnet/core/migration/22-to-30?view=aspnetcore-5.0&tabs=visual-studio#framework-reference)
- [[Deep-dive into .NET Core primitives](./docs/deps.json, runtimeconfig.json, and dll's](https://natemcmaster.com/blog/2017/12/21/netcore-primitives/)
- [[Deep-dive into .NET Core primitives, part 2](./docs/the shared framework](https://natemcmaster.com/blog/2018/08/29/netcore-primitives-2/)
- [[Deep-dive into .NET Core primitives, part 3](./docs/runtimeconfig.json in depth](https://natemcmaster.com/blog/2019/01/09/netcore-primitives-3/)
...
- [[SERIES](./docs/WRITING HIGH-PERFORMANCE C# AND .NET CODE](https://www.stevejgordon.co.uk/writing-high-performance-csharp-and-dotnet-code)
<div align="right">
  <b><a href="#contents">↥ Back To Top</a></b>
</div>
...
- [[Part 1](./docs/Motivations for Writing High-Performance C# Code](https://www.stevejgordon.co.uk/motivations-for-writing-high-performance-csharp-code) - [Steve Gordon
- [[Part 2](./docs/Introduction to Benchmarking C# Code with Benchmark .NET](https://www.stevejgordon.co.uk/introduction-to-benchmarking-csharp-code-with-benchmark-dot-net) - [Steve Gordon
- [[Part 3](./docs/An Introduction to Optimising Code Using Span<T>](https://www.stevejgordon.co.uk/an-introduction-to-optimising-code-using-span-t) - [Steve Gordon
- [[Part 4](./docs/Creating Strings with No Allocation Overhead Using String.Create](https://www.stevejgordon.co.uk/creating-strings-with-no-allocation-overhead-using-string-create-csharp) - [Steve Gordon
- [[Part 5](./docs/Profiling .NET Core Memory Traffic using JetBrains dotMemory](https://www.stevejgordon.co.uk/profiling-dotnetcore-memory-traffic-using-jetbrains-dotmemory) - [Steve Gordon
- [[Part 6](./docs/Interpreting the .NET Core Memory Timeline in JetBrains dotMemory](https://www.stevejgordon.co.uk/interpreting-the-dotnet-core-memory-timeline-in-jetbrains-dotmemory) - [Steve Gordon
- [[Part 7](./docs/Analysing the Large Object Heap in JetBrains dotMemory](https://www.stevejgordon.co.uk/analysing-the-large-object-heap-in-jetbrains-dotmemory) - [Steve Gordon
...
- [[C# 7.2](./docs/Understanding Span](https://channel9.msdn.com/Events/Connect/2017/T125)

### Books
- [[Pro .NET Memory Management](./docs/For Better Code, Performance, and Scalability](https://www.amazon.co.uk/gp/product/148424026X/)
...
- [[The ASP.NET Core Generic Host](./docs/namespace clashes and extension methods](https://andrewlock.net/the-asp-net-core-generic-host-namespace-clashes-and-extension-methods/)
...
- [[Customizing ASP.​NET Core Part 11](./docs/WebHostBuilder](https://asp.net-hacker.rocks/2019/01/30/customizing-aspnetcore-11-webhostbuilder.html)
...
- [[Munich .NET Meetup](./docs/Anatomy of ASP.NET Core Requests by Steve Gordon](https://www.youtube.com/watch?v=zMU_LGbTsCQ)
...
- [[Customizing ASP.NET Core Part 12](./docs/Hosting](https://asp.net-hacker.rocks/2019/04/29/customizing-aspnetcore-12-hosting.html)
...
- [[DEEP DIVE](./docs/HOW IS THE ASP.NET CORE MIDDLEWARE PIPELINE BUILT?](https://www.stevejgordon.co.uk/how-is-the-asp-net-core-middleware-pipeline-built)
...
- [[Customizing ASP.​NET Core Part 06](./docs/Middlewares](https://asp.net-hacker.rocks/2018/10/08/customizing-aspnetcore-06-middlewares.html)
...
- [[ASP.NET Monsters #91](./docs/Middleware vs. Filters](https://channel9.msdn.com/Series/aspnetmonsters/ASPNET-Monsters-91-Middleware-vs-Filters)
...
- [[Customizing ASP.​NET Core Part 02](./docs/Configuration](https://asp.net-hacker.rocks/2018/09/24/customizing-aspnetcore-02-configuration.html)
...
- [[.NET 5](./docs/Exploring System.Net.Http.Json namespace](https://anthonygiretti.com/2020/10/03/net-5-exploring-system-net-http-json-namespace/)
...
- [[Beginner's Series to](./docs/Web APIs](https://channel9.msdn.com/Series/Beginners-Series-to-Web-APIs)

### 📝 Articles
- [[Microsoft REST API Guidelines](https://github.com/microsoft/api-guidelines/blob/vNext/Guidelines.md))
- [[Web API design](https://docs.microsoft.com/en-us/azure/architecture/best-practices/api-design)
- [[ASP.NET Core 5 Route to Code](./docs/Taking advantage of Microsoft.AspNetCore.Http json extensions](https://anthonygiretti.com/2020/09/29/asp-net-core-5-route-to-code-taking-advantage-of-microsoft-aspnetcore-http-json-extensions/)
...
- [[Asp.Net Core Model Binding](./docs/Controlling The Binding Source](https://hamidmosalla.com/2017/07/06/asp-net-core-model-binding-controlling-the-binding-source/)
...
- [[RESTful API Design](./docs/13 Best Practices to Make Your Users Happy](https://florimond.dev/blog/articles/2018/08/restful-api-design-13-best-practices-to-make-your-users-happy/)
...
- [[GRAPHQL VS REST](./docs/WHICH ONE IS BETTER?](https://www.imaginarycloud.com/blog/graphql-vs-rest/)
### 📹 Videos
...
- [[Google I/O 2012 - [SQL vs NoSQL](./docs/Battle of the Backends](https://www.youtube.com/watch?v=rRoy6I4gKWU)
...
- [[Exploring the .NET Core Docker files](./docs/dotnet vs aspnetcore vs aspnetcore-build](https://andrewlock.net/exploring-the-net-core-docker-files-dotnet-vs-aspnetcore-vs-aspnetcore-build/)
- [[Exploring the .NET Core 2.1 Docker files (updated)](./docs/dotnet:runtime vs aspnetcore-runtime vs sdk](https://andrewlock.net/exploring-the-net-core-2-1-docker-files-dotnet-runtime-vs-aspnetcore-runtime-vs-sdk/)
...
- [[Customizing ASP.​NET Core Part 05](./docs/HostedServices](https://asp.net-hacker.rocks/2018/10/04/customizing-aspnetcore-05-hostedservices.html)
...
- [[.NET Core Dependency Injection](./docs/Everything You Ought To Know](https://www.blog.jamesmichaelhickey.com/NET-Core-Dependency-Injection/)
...
- [[Customizing ASP.​NET Core Part 03](./docs/Dependency Injection](https://asp.net-hacker.rocks/2018/09/27/customizing-aspnetcore-03-dependency-injection.html)
...
- [[ASP.NET CORE DEPENDENCY INJECTION](./docs/WHAT IS THE ISERVICEPROVIDER AND HOW IS IT BUILT?](https://www.stevejgordon.co.uk/aspnet-core-dependency-injection-what-is-the-iserviceprovider-and-how-is-it-built) - [Steve Gordon
...
- [[Scaffold Your Clean DDD Web Application - [Part 2](./docs/Authentication and Identity](https://blog.jacobsdata.com/2020/09/15/scaffold-your-clean-ddd-web-application-part-2-authentication-and-identity)
- [[Identity model customization in ASP.NET Core](https://docs.microsoft.com/en-us/aspnet/core/security/authentication/customize-identity-model)
- [[Introduction to Identity on ASP.NET Core](https://docs.microsoft.com/en-us/aspnet/core/security/authentication/identity)
...
- [[ASP.NET Core - [Claims Based Authentication](./docs/Claims vs Identities vs Principals](https://eddieabbondanz.io/post/aspnet/claims-based-authentication-claims-identities-principals/)
...
- [[Series](./docs/Using Serilog.AspNetCore in ASP.NET Core 3.0](https://andrewlock.net/series/using-serilog-aspnetcore-in-asp-net-core-3/)
...
- [[Munich .NET Meetup](./docs/Massive load testing with NBomber cluster](https://www.youtube.com/watch?v=U2j7NmXZrOc)
- [[ASP.NET Core Series](./docs/Performance Testing Techniques](https://www.youtube.com/watch?v=jn54CjePzs0)
...
- [[Error handling](./docs/Exception or Result?](https://enterprisecraftsmanship.com/posts/error-handling-exception-or-result/) - [Vladimir Khorikove
...
- [[REST API response codes](./docs/400 vs 500](https://enterprisecraftsmanship.com/posts/rest-api-response-codes-400-vs-500/) - [Vladimir Khorikove
...
- [[Entity Framework Core 3.0](./docs/A Foundation for the Future](https://codemag.com/Article/1911062/Entity-Framework-Core-3.0-A-Foundation-for-the-Future)
...
- [[EF Core Power Tools database reverse engineering](./docs/renaming of entities and properties](https://erikej.github.io/efcore/2020/09/07/ef-core-power-tools-renaming-advanced.html)
...
- [[Entity Framework Community Standup - [Open Source Contributions](./docs/How to Add a Feature to EF Core](https://www.youtube.com/watch?v=9OMxy1wal1s)
### 📦 Libraries
...
- [[EF Core 5](./docs/Building on the Foundation](https://www.codemag.com/Article/2010042/EF-Core-5-Building-on-the-Foundation)
...
- [[REDIS VS MEMCACHED](./docs/WHICH ONE TO CHOOSE?](https://www.imaginarycloud.com/blog/redis-vs-memcached)
- [[Redis vs. Memcached](./docs/In-Memory Data Storage Systems](https://alibaba-cloud.medium.com/redis-vs-memcached-in-memory-data-storage-systems-3395279b0941)
...
- [[Analyzing performance with BenchmarkDotNet - [ASP.NET Core](./docs/From 0 to overkill](https://www.youtube.com/watch?v=8JOC8kN_WbU)
...
- [[GETTING STARTED WITH THE ROSLYN APIS](./docs/WRITING CODE WITH CODE](https://www.stevejgordon.co.uk/getting-started-with-the-roslyn-apis-writing-code-with-code)
